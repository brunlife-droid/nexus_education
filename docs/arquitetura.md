...
- A tabela global `tenants` e lida fora do contexto RLS; o pool Postgres usa timeouts curtos de conexao/query e o lookup de tenant cai para o in-code em 2,5s para evitar render pendurado em producao.
