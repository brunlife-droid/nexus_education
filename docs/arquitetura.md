...
- Para demo resiliente, `setClassFocus()` garante as habilidades BNCC conhecidas no DB antes de inserir `class_focus_skills`, cobrindo o caso em que a UI precisou usar fallback de mocks.
