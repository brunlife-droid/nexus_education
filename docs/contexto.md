...
- **P5 Dashboard da Turma real**: heatmap students × habilidades BNCC + lista ordenada por proficiência + KPIs reais; para a turma demo `class-demo-7a`, há fallback de 12 alunos/9 habilidades se o Neon retornar vazio. Ao marcar foco pedagógico, a action garante as habilidades BNCC conhecidas antes de gravar.
